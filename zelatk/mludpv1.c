...
static const unsigned char data[PAYLOAD_SIZE] __attribute__((aligned(ALIGNMENT))) = {
...
void *attack_thread(void *arg) {
    ...
    int reuse = 1, sendbuf = 2 * 1024 * 1024;
    ...
    posix_memalign((void **)&msgs, ALIGNMENT, BATCH_SIZE * sizeof(struct mmsghdr));
    posix_memalign((void **)&iov, ALIGNMENT, BATCH_SIZE * sizeof(struct iovec));
